...
InjectionResult inject_renderer_once(
    ...
    // The stable payload transitions the producer child to ptrace privileges
    // once during bootstrap. FPS sampling never uses this auth path.
    ...
    do {
        ...
        // Stable v0.28b reads the 0x28-byte parameter block back and validates
        // pthread_create's return code stored by the stager at +0x20.
