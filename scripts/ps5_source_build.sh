...
ELF="${ROOT}/dist/Common_FPS_PS5_UNIVERSAL_STAGE8_SELFHOOK_SCAN.elf"
PLUGIN="${ROOT}/dist/Common_FPS_PS5_etaHEN_UNIVERSAL_STAGE8_SELFHOOK_SCAN.plugin"
RENDERER="${ROOT}/dist/Common_FPS_ShellUI_UNIVERSAL_STAGE8_SELFHOOK_SCAN.elf"
