...
ELF="${ROOT}/dist/Common_FPS_PS5_UNIVERSAL_STAGE8_2_STOPPED_MDBG_INDIRECT_SCAN.elf"
PLUGIN="${ROOT}/dist/Common_FPS_PS5_etaHEN_UNIVERSAL_STAGE8_2_STOPPED_MDBG_INDIRECT_SCAN.plugin"
RENDERER="${ROOT}/dist/Common_FPS_ShellUI_UNIVERSAL_STAGE8_2_STOPPED_MDBG_INDIRECT_SCAN.elf"
